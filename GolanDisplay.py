...
simple_font = {
    ...
    'C': [0b01110, 0b10001, 0b10000, 0b10000, 0b01110, 0b00000, 0b00000],
    'D': [0b11110, 0b10001, 0b10001, 0b10001, 0b11110, 0b00000, 0b00000],
    ...
    'J': [0b01110, 0b00010, 0b00010, 0b10010, 0b01100, 0b00000, 0b00000],
    ...
    'Q': [0b01110, 0b10001, 0b10101, 0b10011, 0b01111, 0b00000, 0b00000],
    ...
    'W': [0b10001, 0b10001, 0b10101, 0b10101, 0b01010, 0b00000, 0b00000],
    'X': [0b10001, 0b01010, 0b00100, 0b01010, 0b10001, 0b00000, 0b00000],
    'Y': [0b10001, 0b01010, 0b00100, 0b00100, 0b00100, 0b00000, 0b00000],
    'Z': [0b11111, 0b00010, 0b00100, 0b01000, 0b11111, 0b00000, 0b00000],
...
class GolanDisplay:
    ...
    def display_start_screen(self):
        ...
        self.draw_vertical_text(x_logo_start, y_logo_start, text="NIGGER", color=color565(255, 255, 255), scale=5, spacing=3)
    ...
    def run_animation(self):
        ...
        self.draw_vertical_text(x_start + 40, y_start, text="P", color=color565(0, 0, 0), scale=2, spacing=2)
        ...
        x_logo_start = 2
        y_logo_start = 110
        self.draw_vertical_text(x_logo_start, y_logo_start, text="NIGGER", color=color565(0, 0, 0), scale=3, spacing=2)
